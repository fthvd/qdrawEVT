...
from qgis.PyQt.QtCore import Qt, QCoreApplication, pyqtSignal, QPoint, QRegExp

from qgis.PyQt.QtWidgets import QDialog, QLineEdit, QMessageBox, QDialogButtonBox, \
...
#        Y_val = QDoubleValidator()
        ...
        regex = QRegExp(motif)
        X_val = QRegExpValidator(regex, self.X)
        Y_val = QRegExpValidator(regex, self.Y)
        # fin modif F. THEVAND
